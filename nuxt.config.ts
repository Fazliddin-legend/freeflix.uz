...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      publicUrl: import.meta.env.NUXT_PUBLIC_SITE_URL || 'https://www.freeflix.uz',
      supabase: {
  ...
  site: {
    name: 'Freeflix uz',
    url: import.meta.env.NUXT_PUBLIC_SITE_URL || 'https://www.freeflix.uz',
  },
  ...
  image: {
    domains: ['www.freeflix.uz', 'freeflix.uz', 'freeflix-uz.vercel.app', 'freeflix.netlify.app', 'freeflix-uz.netlify.app', 'image.tmdb.org', 'i.pinimg.com', 'musicart.xboxlive.com', 'avatars.mds.yandex.net', 'cdn.culture.ru', 'gauokzjbwdzovotccymx.supabase.co'],
    format: ['webp']
  },
