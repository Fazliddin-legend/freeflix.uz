        ...
        <div sm:ml-6>
          <div sm:border-l sm:border-gray-200 sm:pl-6>
            ...
            <div mt-2 flex flex-col gap-2>
              ...
              <div>
                <a href="https://t.me/islom_here" target="_blank" inline-flex items-center gap-2 border-1 border-gray-500 rounded-lg px-2 py-1 icon-btn hover:border-dark-green>Freeflix support <div i-carbon-chat inline-block /></a>
              </div>
            </div>
          </div>
